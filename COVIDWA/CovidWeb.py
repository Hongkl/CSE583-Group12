...
We mainly use "panel" library to realize the widgets and the dashboard.
Panel supports using parameters and dependencies between parameters as expressed.
by "param" in a simple way toencapsulate dashboards as declarative, self-contained classes.
